...
def cases_menu(call):
    ...
    bot.send_message(uid, "📦 **Выбери кейс:**\n🥉 Бронзовый (25) — 10% на Crack Plus\n🥈 Серебряный (300) — 25% на Crack Plus\n💎 Легендарный (1250) — 45% на Crack Plus", parse_mode="Markdown", reply_markup=kb)
